<div class="grid cart_admin_nav">
	<nav class="col basic_nav">
		<ul>
			...
			<li><?php echo HTML::anchor(Route::get('cart_admin')->uri(array('action' => 'order')), 'Orders'); ?></li>
			<li><?php echo HTML::anchor(Route::get('cart_admin')->uri(array('action' => 'shipping')), 'Shipping Rates'); ?></li>
			<li><?php echo HTML::anchor(Route::get('cart_admin')->uri(array('action' => 'tax')), 'Taxes'); ?></li>
		</ul>
	</nav>
</div>